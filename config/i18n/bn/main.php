...
return array(
    ...
    "system_setting_root_path_desc"  => "শুধু একজন সিস্টেম প্রশাসকের সব ডিরেক্টরি অ্যাক্সেস করতে পারেন, ব্যবহারকারীরা অন্য অধিকার সংগঠনগুলো শুধুমাত্র তাদের নিজস্ব ব্যবহারকারী ডাইরেক্টরি দেখতে পারেন। আপনার উপর বা অন্যান্য ডিরেক্টরি থেকে<br/>প্রশাসক অ্যাক্সেস বন্ধ করতে চান, আপনি, বিরোধী ক্রস সাইট পরামিতি open_basedir পিএইচপি পরিবর্তন করতে পারেন<a href=\"https://www.google.com.hk/search?&q=php+open_basedir\" target=\"_ lank\"></a>",
    "system_group_role_title"        => "দল সংক্রান্ত অনুমতি প্রদান ভূমিকা পরিচালনা",
    "system_group_role_remove"       => "গ্রুপ ভূমিকা মুছতে ওকে",
    "system_group_role_style"        => "শৈলী",
    "system_group_role_display"      => "কিনা",
    "system_group_role_display_desc" => "একটি গ্রুপ সেটিং ব্যবহারকারীর অনুমতি কিনা",
    ...
    "group_guest"                    => "দর্শকরা",
    "group_guest_desc"               => "আপনি এই দলের সদস্য শুধুমাত্র [গ্রুপ ভাগ করা ডাইরেক্টরি] নিম্নলিখিত, শুধুমাত্র পাঠযোগ্য এক্সেস এক্সেস নয়,<br/>।",
    "group_role_lebel_desc"          => "আপনার কাছে অ্যাডমিনস্ট্রেটর Jun দ্বারা নির্ধারিত সব অপারেটিং অধিকার গ্রুপ<br/>ডকুমেন্টেশন মধ্যে, গ্রুপ এর একজন সদস্য",
    ...
    "setting_show_share_user_desc"   => "সকল ব্যবহারকারীর বৃক্ষ রুট ডিরেক্টরিটি ভাগ গ্রুপ তালিকাভুক্ত করা হয়",
