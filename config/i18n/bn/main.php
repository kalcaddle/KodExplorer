...
return array(
    ...
    "share"                          => "ভাগ",
    "my_share"                       => "আমি ভাগ",
    "group_share"                    => "বিদেশী ভাগ গোষ্ঠীসমূহ",
    ...
    "unknow_file_office"             => "অফিস প্রিভিউ, kodcloud প্রয়োজন নেটওয়ার্কের বাইরে মোতায়েন করা<br/><br/><a href=\"http://kodcloud.com/office.html\" target=\"_blank\">বিস্তারিত></a>",
    ...
    "copyright_contact"              => "করার অনুমোদন বা কাস্টমাইজড, অনুগ্রহ করে যোগাযোগ করুন কিউকিউ: <a href=\"http://wpa.qq.com/msgrd?v=3&uin=3532208565&site=qq&menu=yes\" target=\"_blank\">3532208565</a> <a href=\"javascript:core.openWindow('http://kodcloud.com/qa.html');\">সমস্যা প্রতিক্রিয়া</a>",
    ...
    "rename"                         => "পুনঃনামকরণ",
    "add_to_fav"                     => "বুকমার্ক যোগ করুন",
    "search_in_path"                 => "ফোল্ডার খোঁজা",
    "add_to_play"                    => "প্লেতালিকায় জুড়ুন",
    "manage_fav"                     => "বুকমার্কগুলি পরিচালনা",
