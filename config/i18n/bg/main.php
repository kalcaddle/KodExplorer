...
return array(
    ...
    "system_group_role_title"        => "Група за управление на Разрешения Роля",
    "system_group_role_remove"       => "Спокойно можете да изтриете ролята на група",
    "system_group_role_style"        => "стил",
    "system_group_role_display"      => "дали",
    "system_group_role_display_desc" => "Дали обстановката група разрешения на потребител",
    ...
    "group_guest_desc"               => "Вие не сте член на тази група,<br/>достъп само до [груповата поделената директория] след, достъп само за четене.",
    "group_role_lebel_desc"          => "Вие сте член на групата, в рамките на документация групата<br/>за всички операционни права, предоставени от администратора юни",
    ...
    "unknow_file_office"             => "офис преглед, kodcloud нужда да бъдат разположени извън мрежата<br/><br/><a href=\"http://kodcloud.com/office.html\" target=\"_blank\">детайли></a>",
    ...
    "copyright_contact"              => "Разрешава или персонализирана, моля свържете се с QQ: <a href=\"http://wpa.qq.com/msgrd?v=3&uin=3532208565&site=qq&menu=yes\" target=\"_blank\">3532208565</a> <a href=\"javascript:core.openWindow('http://kodcloud.com/qa.html');\">проблем Обратна връзка</a>",
    ...
    "setting_show_share_user_desc"   => "е вписана групата Tree главната директория на всички потребители споделят",
