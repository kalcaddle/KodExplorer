...
return array(
    ...
    "group_guest_desc"               => "Sie sind kein Mitglied der Abteilung,<br/>Nur der Zugriff auf das freigegebene Verzeichnis der Abteilung [Abteilung] ist mit Lesezugriffsrechten möglich.",
    "group_role_lebel_desc"          => "Sie sind ein Mitglied dieser Abteilung,<br/>Alle Dokumente in der Abteilung Alle Rechte vorbehalten vom Administrator",
    ...
    "userNickName"                   => "Benutzer-Nickname",
    "password"                       => "Kennwort",
    "login_code"                     => "Codes",
    ...
    "setting_show_root_group"        => "Alle Abteilungen auflisten",
    "setting_show_root_group_desc"   => "Stammverzeichnis des Baumverzeichnisses, ob alle Abteilungen aufgelistet werden sollen",
    "setting_show_share_user"        => "Eine Liste aller Benutzer",
    "setting_show_share_user_desc"   => "Die Root-Abteilung des Baumverzeichnisses wird für alle Benutzerfreigaben aufgelistet.",
    ...
    "Plugin.config.authGroup"        => "Benannte Abteilung",
