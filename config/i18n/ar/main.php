...
return array(
    ...
    "system_group_role_title"        => "فريق إدارة ضوابط دور",
    "system_group_role_remove"       => "موافق لحذف دور المجموعات",
    "system_group_role_style"        => "أسلوب",
    "system_group_role_display"      => "سواء",
    "system_group_role_display_desc" => "إذا كان أذونات المستخدم إعداد مجموعة",
    ...
    "group_guest"                    => "آخر",
    "group_guest_desc"               => "أنت لست عضوا في هذه المجموعة،<br/>الوصول فقط إلى [المجموعة الدليل المشترك] التالية، والوصول للقراءة فقط.",
    "group_role_lebel_desc"          => "كنت عضوا في المجموعة، ضمن وثائق مجموعة<br/>جميع حقوق العاملة المخصصة من قبل المسؤول يونيو",
    ...
    "share"                          => "سهم",
    "my_share"                       => "أنا مشتركة",
    "group_share"                    => "دليل المجموعات المشتركة",
    ...
    "unknow_file_tips"               => "لا يدعم المفتوحة",
    "unknow_file_download"           => "تحميل",
    ...
    "copyright_contact"              => "يأذن أو حسب الطلب، يرجى الاتصال QQ: <a href=\"http://wpa.qq.com/msgrd?v=3&uin=3232048103&site=qq&menu=yes\" target=\"_blank\">3232048103</a> <a href=\"javascript:core.openWindow('http://kalcaddle.com/qa.html');\">المشكلة تعليقات</a>",
    ...
    "setting_show_share_user_desc"   => "دليل جذر شجرة من كل مستخدمين تبادل يتم سرد مجموعة",
    ...
    "path_null"                      => "مجلد فارغ، يمكنك سحب وإسقاط تحميل الملفات",
    ...
    "setting_fav"                    => "مدير المفضلة",
    "setting_player"                 => "لاعب",
    "setting_player_music"           => "ضبط مشغل الموسيقى",
    "setting_player_movie"           => "إعدادات مشغل فيديو",
    ...
    "group_role_fav"                 => "عمليات المفضلة (إضافة / تحرير / حذف)",
