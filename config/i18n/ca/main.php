...
return array(
    ...
    "system_group"                   => "Els usuaris i grups",
    "system_group_edit"              => "grup de Gestió",
    "system_group_role"              => "identitat de rol",
    "system_group_create"            => "crear grup",
    "system_group_name"              => "Nom del grup",
    "system_group_father"            => "El grup superior",
    "system_group_add"               => "Addició d'subpaquete",
    ...
    "system_group_action"            => "grup de Gestió",
    ...
    "unknow_file_office"             => "vista prèvia de l'oficina, kodcloud necessitat de ser desplegat fora de la xarxa<br/><br/><a href=\"http://kodcloud.com/office.html\" target=\"_blank\">detalls></a>",
    ...
    "copyright_contact"              => "Autoritzar o personalitzat, poseu-vos en contacte amb QQ: <a href=\"http://wpa.qq.com/msgrd?v=3&uin=3532208565&site=qq&menu=yes\" target=\"_blank\">3532208565</a> <a href=\"javascript:core.openWindow('http://kodcloud.com/qa.html');\">problema Comentaris</a>",
    ...
    "setting_show_share_user_desc"   => "directori arrel de l'arbre de tots els usuaris comparteixen el grup és a la llista",
    ...
    "order_asc"                      => "ascendent",
    "rename"                         => "rebatejar",
    "add_to_fav"                     => "Afegir a Favorits",
    "search_in_path"                 => "Cerca de carpeta",
    "add_to_play"                    => "Afegir a la llista",
    "manage_fav"                     => "administrar els marcadors",
