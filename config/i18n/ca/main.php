...
return array(
    ...
    "search_in_path"                 => "carpeta de recerca",
    "add_to_play"                    => "Afegir a la llista",
    "manage_fav"                     => "administrar favorits",
    ...
    "setting_fav"                    => "gestor de favorits",
    "setting_player"                 => "jugador",
    "setting_player_music"           => "la configuració del reproductor de música",
    "setting_player_movie"           => "Configuració del reproductor de vídeo",
