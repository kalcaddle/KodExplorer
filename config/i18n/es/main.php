...
return array(
    ...
    "my_kod_group"                   => "Estoy en el departamento",
    ...
    "system_group"                   => "Usuarios y departamentos",
    "system_group_edit"              => "Gerencia del departamento",
    "system_group_role"              => "identidad de rol",
    "system_group_create"            => "Nuevo departamento",
    "system_group_name"              => "Nombre del departamento",
    "system_group_father"            => "Departamento superior",
    "system_group_add"               => "Añadir subdepartamento",
    "system_group_remove"            => "Eliminar el departamento",
    ...
    "system_member_group"            => "Donde el departamento",
    "system_member_group_edit"       => "Departamento de redacción",
    ...
    "group_guest_desc"               => "Usted no es miembro del departamento,<br/>solo puede acceder al [directorio compartido del departamento] el siguiente contenido, permisos de solo lectura.",
    "group_role_lebel_desc"          => "Usted es un miembro del departamento, departamento de documentación dentro<br/>todas las operaciones por el administrador para asignar permisos",
    ...
    "setting_show_root_group"        => "Enumerar todos los departamentos",
    "setting_show_root_group_desc"   => "Directorio de árbol, departamento raíz, ya sea para enumerar todos los departamentos",
    "setting_show_share_user"        => "Una lista de todos los usuarios",
    "setting_show_share_user_desc"   => "El departamento raíz del directorio de árbol se incluye para todos los usuarios que comparten",
