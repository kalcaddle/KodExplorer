...
return array(
    ...
    "system_group_role_title"        => "Management Group autorizzazioni di ruolo",
    "system_group_role_remove"       => "OK per eliminare il ruolo del gruppo",
    "system_group_role_style"        => "stile",
    "system_group_role_display"      => "se",
    "system_group_role_display_desc" => "Sia un contesto di gruppo autorizzazioni utente",
    ...
    "setting_show_root_group"        => "Un elenco di tutti i gruppi",
    "setting_show_root_group_desc"   => "Albero gruppo directory principale è elencato tutti i gruppi",
    "setting_show_share_user"        => "Un elenco di tutti gli utenti",
    "setting_show_share_user_desc"   => "Radice di albero di directory di tutti gli utenti condividono la Finmeccanica, quotata",
    ...
    "manage_fav"                     => "Gestisci segnalibri",
