...
return array(
    ...
    "system_group"                   => "用户与部门",
    "system_group_edit"              => "部门管理",
    "system_group_role"              => "角色身份",
    "system_group_create"            => "新建部门",
    "system_group_name"              => "部门名称",
    "system_group_father"            => "上级部门",
    "system_group_add"               => "添加子部门",
    "system_group_remove"            => "删除部门",
    ...
    "system_member_group"            => "所在部门",
    "system_member_group_edit"       => "编辑部门",
    ...
    "system_group_role_remove"       => "确定删除部门角色",
    ...
    "group_guest"                    => "访客",
    "group_guest_desc"               => "您不是该部门成员，<br/>仅能访问[部门共享目录]下面的内容,只读权限.",
    "group_role_lebel_desc"          => "您是该部门成员，<br/>部门内文档所有操作权限均由管理员分配",
    ...
    "setting_show_root_group"        => "罗列所有部门",
    "setting_show_root_group_desc"   => "树目录根部门是否列出所有部门",
    "setting_show_share_user"        => "罗列所有用户",
    "setting_show_share_user_desc"   => "树目录根部门是否列出所有用户分享",
    ...
    "group_tips"                     => "<li>1.用户组名不能重复，修改组名后原属于改组用户会自动关联</li><li>2.扩展名限制关系系统安全性，请务必谨慎操作<i>(如果在web目录下新建php;就意味着改程序的权限对此用户形同虚设)</i></li><li>3.户管理、权限组管理；查看权限和增删改权限是绑定的；程序会自动关联</li><li>4.设定权限组能添加权限组后，后续权限是不继承的<i>（此权限相当于最高权限）</i></li>",
    "not_null"                       => "必填项不能为空!",
    ...
    "Plugin.config.authOpenDesc"     => "无需登录皆可访问,可用于对外接口调用",
