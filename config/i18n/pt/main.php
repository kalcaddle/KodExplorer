...
return array(
    ...
    "system_group_role_title"        => "Grupo de Gerenciamento de permissões de função",
    "system_group_role_remove"       => "OK para excluir o papel grupo",
    "system_group_role_style"        => "estilo",
    "system_group_role_display"      => "se",
    "system_group_role_display_desc" => "Se um ambiente de grupo permissões de usuário",
    ...
    "setting_show_root_group"        => "Uma lista de todos os grupos",
    "setting_show_root_group_desc"   => "Árvore grupo diretório raiz está listado todos os grupos",
    "setting_show_share_user"        => "Uma lista de todos os usuários",
    "setting_show_share_user_desc"   => "diretório raiz da árvore de todos os usuários compartilham o grupo está listado",
    ...
    "rename"                         => "rebatizar",
    "add_to_fav"                     => "Adicionar aos marcadores",
    "search_in_path"                 => "Pesquisa de pastas",
    "add_to_play"                    => "Adicionar à Playlist",
    "manage_fav"                     => "Gerenciar marcadores",
