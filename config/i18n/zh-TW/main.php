...
跨站open_basedir參數,<a href=\"https://www.baidu.com/s?wd=php+open_basedir\" target=\"_blank\">如何設定</a>",
    ...
    "php_env_error_list_dir"         => "您的web伺服器開啟了列目錄功能，為安全考慮請禁用該功能！<a href=\"http://jingyan.baidu.com/article/22fe7ced389a0f3003617f41.html\" 
...
",
    "copyright_desc"                 => "Kodexplorer是一款備受好評的web檔案管理系統，你可以用它來做內部檔案管理或共享、也可以用來管理伺服器上的網站，取代Ftp，甚至可以當作
...
上辦公等提供安全可控，簡便易用、可高度訂製的私有雲產品。採用windows風格介面、操作習慣，無需適應即可快速上手，支援幾百種常用檔案格式的線上預覽、播放和編輯，環境友
