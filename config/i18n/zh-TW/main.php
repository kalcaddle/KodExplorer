...
return array(
    ...
    "system_group_role_title"        => "群組權限角色管理",
    "system_group_role_remove"       => "確定刪除群角色",
    "system_group_role_style"        => "樣式",
    "system_group_role_display"      => "是否顯示",
    "system_group_role_display_desc" => "設置群組用戶權限時是否顯示",
    ...
    "group_guest"                    => "訪客",
    "group_guest_desc"               => "您不是該群組成員，<br/>僅能訪問[群組共享目錄]下面的內容,只讀權限.",
    "group_role_lebel_desc"          => "您是該群組成員，<br/>群內文檔所有操作權限君由管理員分配",
    ...
    "unknow_file_office"             => "Office預覽,此程式需要部署在外部網路<br/><br/><a href=\"http://kodcloud.com/office.html\" target=\"_blank\">详情></a>",
    ...
    "copyright_contact"              => "授權或定制請聯繫QQ: <a href=\"http://wpa.qq.com/msgrd?v=3&uin=3532208565&site=qq&menu=yes\" target=\"_blank\">3532208565</a> <a href=\"javascript:core.openWindow('http://kodcloud.com/qa.html');\">問題反饋</a>",
    ...
    "setting_show_share_user_desc"   => "樹目錄根群組是否列出所有用戶分享",
