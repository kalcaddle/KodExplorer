...
class setting extends Controller
{
    ...
    public function slider()
    {
        switch ($this->in['slider']) {
            case 'about':
                show_json(file_get_contents(LANGUAGE_PATH.LANGUAGE_TYPE.'/about.html'));
                break;
            case 'help':
                show_json(file_get_contents(LANGUAGE_PATH.LANGUAGE_TYPE.'/help.html'));
                break;
            case 'member':
                break;
            case 'fav':
    ...
    public function system_tools()
    {
        ...
        switch ($action) {
            ...
            case 'clear_session':
                $this->clear_session();
                break;
            case 'clear_user_recycle':
                $this->clear_user_recycle();
                break;
            default:
                break;
        }
