define("app/src/setting/main", ["lib/jquery-lib", "lib/util", "lib/artDialog/jquery-artDialog", "../../common/core", "../../tpl/copyright.html", "../../tpl/search.html", "../../tpl/search_list.html", "../../tpl/upload.html", "./setting", "./fav", "./group", "./member", "./system"], function(e) {
    ...
    var e, t = "index.php?member/",
        ...
        s = function(e, t) {
            ...
            var o = "<tr name='" + urlDecode(e) + "' role='" + t + "'>" + "   <td>" + urlEncode2(e) + "</td>" + "   <td><a href='javascript:void(0)' class='edit_role'>" + a + "</a></td>" + "   <td>" + n + "</td>" + "</tr>";
            return o
        },
        r = function(e, t, i) {
        ...
        f = function() {
            ...
            $.dialog({
                ...
                drag: !0,
                title: LNG.warning,
                content: LNG.if_remove + urlEncode2(a) + "<br/>" + LNG.member_remove_tips,
                ok: function() {
                    $.ajax({
                        url: t + "del&name=" + a,
                        dataType: "json",
