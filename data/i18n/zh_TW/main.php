...
$L= array(
	...
	"group_tips"=>"<li>1.用護組名不能重複，修改組名後原屬於改組用護會自動關聯</li><li>2.擴展名限制關系系統安全性，請務必謹慎操作<i>(如果在web目錄下新建php;就意味著改程式的許可權對此用護形同虛設)</i></li><li>3.護管理、許可權組管理；查看許可權和增刪改許可權是邦定的；程式會自動關聯</li><li>4.設定許可權組能添加許可權組後，後續許可權是不繼承的<i>（此許可權相當於最高許可權）</i></li>",	
